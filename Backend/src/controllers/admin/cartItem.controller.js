...
export const createCartItem = async (req, res) => {
  try {
    const newRecord = await CartItem.create(req.body);
...
export const getCartItemById = async (req, res) => {
  try {
    const record = await CartItem.findByPk(req.params.id);
...
export const updateCartItem = async (req, res) => {
  try {
    ...
    if (updated) {
      const updatedRecord = await CartItem.findByPk(req.params.id);
